...
Scientists learn from books, but the continuous learning happens in the lab.  
This repo contains experiments, projects, scripts which are used for learning, exploring and testing.  

## Build your own Redis
Network programming, data structures, and low-level C. Practices via building my own Redis in C/C++.
Follow this book: https://build-your-own.org/redis/
